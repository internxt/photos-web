        ...
        <div className="container-register">
          ...
          <Form className="form-register" onSubmit={(e: any) => {
            ...
            <Form.Row className="form-register-submit">
              <Form.Group as={Col}>
                <Button className="on btn-block __btn-new-button" disabled={!isValid || isLoging} type="submit">{isLoging ? <Spinner animation="border" variant="light" style={{ fontSize: 1, width: '1rem', height: '1rem' }} /> : 'Sign in'}</Button>
              </Form.Group>
            </Form.Row>
          </Form>
        </div>
